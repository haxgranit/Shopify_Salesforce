...
(async () => { 
	...
	await page.goto('https://store.optum.com/shop/category/medication-treatment/stomach-digestive/', {waitUntil: 'networkidle0',}); 
  ...
  const products = await page.evaluate(() => {
    ...
    return Array.from(document.querySelectorAll('a.Product-module_product-card__image__vfsYJ'), (productLink) => {
      let product = {link: '',alt: '',price: '',Status: 'active',Vendor: 'GeissMed',ProductCategory: 'Health & Beauty > Health Care',Type: 'Product',UnitType: 'box',Tags: 'pills',Published: 'TRUE',VariantGrams: '',VariantRequiresShipping: 'FALSE',VariantFulfillmentService: 'manual',VariantTaxable: 'FALSE', ImagePosition: '1'}
  ...
  fs.writeFileSync("stomach_digestice_products.csv", csv)
